...
class Captcha:
    def __init__(self):
        ...
        self.Class_captcha_checkbox = "recaptcha-checkbox-unchecked"
        self.Class_captcha_audio = "rc-button goog-inline-block rc-button-audio"
    ...
    def attempt_audio_captcha(self):
        self.driver.find_element_by_class_name(self.Class_captcha_audio).click()


if __name__ == "__main__":
    captcha = Captcha()
    captcha.open_website("https://www.planmember.com/members/contact-us-2-2/")
    time.sleep(6)
    captcha.click_captcha()
    time.sleep(6)
    captcha.attempt_audio_captcha()
